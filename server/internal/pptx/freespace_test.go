...
func TestComposedShapeIsAPlainTextBox(t *testing.T) {
	...
	xml := placeholderShapeXML(2, placeholder, []Paragraph{{Text: "전환 로드맵"}}, "ko-KR", false, Style{}, nil)
	...
	inherited := placeholderShapeXML(2, real, []Paragraph{{Text: "전환 로드맵"}}, "ko-KR", false, Style{}, nil)
