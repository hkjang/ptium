      ...
      <article className="guide-body">
        ...
        <section id="import" className="guide-section">
          ...
          <p>지난 분기 보고서, 잘 먹힌 제안서, 늘 복사해 쓰는 회사 소개.
            ...
            엑셀(<code>.xlsx</code>)·CSV·워드(<code>.docx</code>)·마크다운도 슬라이드가 되고,
          ...
          <ul className="guide-checklist">
            ...
            <li><code>.pdf</code>는 아직 읽지 않습니다 — 글을 꺼내려면 폰트·인코딩·압축을 다루는
              파서가 필요하고, 그 의존성은 폐쇄망 배포의 단순함과 바꿀 만한 것이 아직 아닙니다.</li>
