      ...
      <article className="guide-body">
        <section id="quickstart" className="guide-section">
          ...
          <ol className="guide-steps">
            ...
            <li>다 됐으면 <b>발표</b>로 보여 주거나 <b>내보내기</b>로 PPTX·PDF를 받습니다.</li>
          </ol>
        ...
        <section id="images" className="guide-section">
          ...
          <p className="guide-note">PNG · JPEG · GIF · SVG, 한 장당 16MB까지. 올린 이미지는 계정에 남아 다른 덱에서도 씁니다.
            같은 이름으로 다시 올리면 교체되므로, 로고를 바꾸면 쓰던 덱들이 함께 새 로고가 됩니다.</p>
        </section>
        ...
        <section id="present" className="guide-section">
          ...
          <ul className="guide-checklist">
            ...
            <li><b>내보내기</b> — PPTX는 PowerPoint에서 그대로 편집됩니다(도형·표·차트가 진짜 개체입니다).
              PDF는 배포용입니다.</li>
          </ul>
        </section>
