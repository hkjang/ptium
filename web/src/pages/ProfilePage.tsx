...
import { Check, Palette, Save, Sparkles, UserRound } from 'lucide-react'
...
export function ProfilePage() {
  ...
  return <AppShell title="개인화" eyebrow="MY PREFERENCES" actions={<Button disabled={saving || loading || !loaded} onClick={() => void save()}><Save size={16} /> {saving ? '저장 중…' : '변경사항 저장'}</Button>}>
    <div className="settings-layout"><aside className="settings-anchor-nav"><a href="#identity" className="active"><UserRound size={16} /> 기본 정보</a><a href="#defaults"><Sparkles size={16} /> 생성 기본값</a><a href="#brand"><Palette size={16} /> 브랜드 스타일</a></aside><div className="settings-content">
