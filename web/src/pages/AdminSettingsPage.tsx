...
import { Bot, Brush, Check, ChevronRight, CircleAlert, Eye, EyeOff, LockKeyhole, Save, ShieldCheck, Sparkles } from 'lucide-react'
...
const defaults: Record<SectionKey, Values> = {
  ...
  ai: { provider: 'fallback', base_url: 'https://api.openai.com/v1', model: 'gpt-4.1-mini', api_key: '' },
  oidc: { issuer_url: '', client_id: '', admin_roles: ['ptium-admin', 'admin'] },
