...
describe('a measurement in the reader’s words', () => {
  ...
  it('names every kind the measurement can report', () => {
    const kinds = ['overflow', 'outside', 'collision', 'contrast', 'orphan', 'density', 'notes', 'repeat', 'source', 'echo', 'trimmed', 'link', 'unfinished', 'twiceTitled', 'undescribed', 'tooSmall', 'notesEcho']
