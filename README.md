...
이미 있는 `.pptx`는 **기존 자료 가져오기**로 덱이 됩니다. 제목·요점(들여쓰기)·발표자 노트·표와
슬라이드의 성격이 넘어오고, 표는 새 덱의 디자인으로 다시 그려집니다. 그림과 차트는 가져오지
않고 몇 개였는지 알려 줍니다 — 다른 비율의 디자인에 사진을 옮겨 놓고 괜찮기를 바라는 것보다
정직하기 때문입니다.
